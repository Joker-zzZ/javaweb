 ...
 */
package com.bjpowernode.module.loader;
...
public class Loader extends Preloader {
    ...
    public void init(){
        try {
            view = FXMLLoader.load(getClass().getResource("/com/bjpowernode/module/loader/Loader.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start(Stage primary){
        ...
        scene.getStylesheets().add(getClass().getResource("/com/bjpowernode/theme/css/fonts.css").toExternalForm());
        progressBar = (JFXProgressBar) scene.lookup("#progressBar");
        primary.getIcons().add(new Image("/com/bjpowernode/module/media/icon.png"));
